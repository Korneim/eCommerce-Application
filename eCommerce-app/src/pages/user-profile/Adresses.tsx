                                    ...
                                    >
                                        <p>
                                              <strong>Город: </strong>
                                                {editableAddressIndex === index ? (
                                                    <Input
                                                        ...
                                                        onChange={(e) => {
                                                            ...
                                                            setAddressFormValues({ ...addressFormValues, city: e.target.value })
                                                            if (isValidCity(e.target.value)) {
                                                                setCityError('')
                                                            } else {
                                                                setCityError('Допускаются только буквы. Если название города состоит из нескольких слов используйте пробел');
                                                            }
                                                        }}
                                                    />
                                                ) : (
                                                ...
                                                {editableAddressIndex === index ? (
                                                    <span style={{ color: 'red', marginBottom: '1rem', maxWidth: '50rem', display: 'block' }}>{cityError}</span>
                                                ) : (
                                              ...
                                              <strong>Улица: </strong>
                                                {editableAddressIndex === index ? (
                                                    <Input
                                                        ...
                                                        style={{ width: '200px' }}
                                                        onChange={(e) => {
                                                            setAddressFormValues({...addressFormValues, streetName: e.target.value})
                                                        }}
                                                    />
                                                ) : (
                                                    address.streetName
                                              ...
                                              <strong>Индекс: </strong>
                                                {editableAddressIndex === index ? (
                                                    <Input
                                                        ...
                                                        onChange={(e) => {
                                                            setAddressFormValues({...addressFormValues, postalCode: e.target.value})
                                                ...
                                                {editableAddressIndex === index ? (
                                                    <span style={{ color: 'red', marginBottom: '1rem', display: 'block'}}>{postalCodeError}</span>
                                                ) : (
                                                    <span style={{ color: 'red', marginBottom: '1rem' }}></span>
                                                )}
                                        </p>
